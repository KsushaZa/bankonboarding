...
public class ProductServiceTest {
    ...
    public void calculateCostWithDiscount_shouldReturnCostWithDiscount() {
        ...
        int result = productService.calculateCostWithDiscount(p1, quantity, discountPercent, price);
...
////        when(productRepository.findById("14")).thenReturn(Optional.empty());
//
